        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    @if($product)
                        <h2><a href="{{ route('user.product.filterbycategory',$product->category_id) }}">{{ $product->category->category_name }}</a> > {{ $product->sub_category->subcategory_name }}</h2>
                    @endif
                </div>
            </div>
        </div>
                                    ...
                                    @empty 
                                        <div class="col-lg-12 col-md-12">
                                            <div class="text-center mb-4">
                                                <strong>No Product Are Available In This Sub-Category</strong>
                                            </div><!-- card -->
